...
const Item = () => {
    ...
    React.useEffect(() => {
        let Carts =
            carts && carts.findIndex((item) => item.item._id === id) !== -1;
        if (Carts) {
            setShowCart(true);
        } else {
            setShowCart(false);
    ...
    React.useEffect(() => {
        let favs =
            favorites &&
            favorites.findIndex((item) => item.item._id === id) !== -1;
    ...
    if (item.error) {
        return (
            <div>Error: {item.error.message}: : Please connect to Internet</div>
        );
    } else {
        return (
            <div
                            ...
                            <div className={classes.container}>
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        <Button
                                            onClick={() =>
                                                handleDeleteItem(item.item._id)
                                            }
                                        >
                                            Delete
                                        </Button>
