...
const Payments = ({ total, cartIds }) => {
  ...
  }, [cartIds, dispatch, paymentMethod]);
  ...
  const handleSubmit = async (event) => {
    ...
    if (payload.error) {
      ...
      dispatch(CreateOrderPayments(cartIds, Payment, id));
    }
  };
        ...
        >
          {paymentMethod ? (
            <div className='Result'>
              ...
              >
                Thank you for your order. Your order number is <br />
                {paymentMethod.id}.
